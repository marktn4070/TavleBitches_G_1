...
def koer():
    ...
    pi_pwm.ChangeDutyCycle(45) #45 #70
    pi_pwm1.ChangeDutyCycle(50) #50 #80
    #sleep(0.1)
...
def dven():
    ...
    pi_pwm.ChangeDutyCycle(60) #50 #80
    pi_pwm1.ChangeDutyCycle(50) #50 #100
    sleep(0.05)
...
def dhoej():
    ...
    pi_pwm.ChangeDutyCycle(60) #50 #100
    pi_pwm1.ChangeDutyCycle(50) #50 #80
    sleep(0.05)
